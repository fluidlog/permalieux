...
import { AvatarWithLabelField, QuickAppendReferenceArrayField, ReferenceArrayField, SeparatedListField } from '@semapps/field-components';
    ...
    <Grid container spacing={5}>
      <Grid item xs={12} sm={9}>
        <Hero>
          ...
          <ReferenceArrayField source="heco:hasType" reference="Type">
      ...
      <Grid item xs={12} sm={3}>
        <SideList>
          <ReferenceArrayField reference="Actor" source="heco:heldAt" sort={{ field: 'type', order: 'ASC' }}>
